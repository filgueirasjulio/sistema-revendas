<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-header card-title">Últimos itens comprados deste fornecedor:</div>
        @else
        <div class="card-header card-title">Últimos itens vendidos para este cliente:</div>
        @endif    
        <div class="card-body">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <span class="badge badge-{{ $movimentoEstoque->tipo === 'entrada' ? 'success' : 'primary' }}" style="padding:10px; width:57px;">{{ ucfirst($movimentoEstoque->tipo) }}</span> </td>
